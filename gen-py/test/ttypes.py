...
class message(object):
    ...
    def __init__(self, seqId=None, content=None,):
        self.seqId = seqId
    ...
    def write(self, oprot):
        ...
        if self.seqId is not None:
            oprot.writeFieldBegin('seqId', TType.I32, 1)
            oprot.writeI32(self.seqId)
            oprot.writeFieldEnd()
